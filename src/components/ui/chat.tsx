...
export function Chat({
  ...
  return (
    <ChatContainer className={className}>
      ...
      <ChatForm
        className="mt-auto pb-4 sm:px-20 lg:px-40 px-5"
...
export function ChatMessages({
  ...
  return (
    <div
      className="grid grid-cols-1 overflow-y-auto py-4 sm:px-20 lg:px-40 px-5 h-[430px]"
      ref={containerRef}
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      className={cn("grid max-h-full w-full grid-rows-[1fr_auto] h-full", className)}
      {...props}
    />
  )
})
